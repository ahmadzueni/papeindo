...
function intime_custom_archive_service_link() {
...
add_action( 'template_redirect', 'intime_custom_archive_service_link' );

function intime_custom_archive_portfolio_link() {
...
add_action( 'template_redirect', 'intime_custom_archive_portfolio_link' );
