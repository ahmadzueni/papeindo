...
ct_add_custom_widget(
    array(
        'name' => 'ct_service_external_grid',
        'title' => esc_html__('Services External Grid', 'intime'),
                        ...
                        array(
                            ...
                            'options' => [
                                '1' => [
                                    ...
                                    'image' => get_template_directory_uri() . '/elementor/templates/widgets/ct_service_external_grid/layout-image/layout1.jpg'
                                ],
                            ],
                        ),
                    ),
