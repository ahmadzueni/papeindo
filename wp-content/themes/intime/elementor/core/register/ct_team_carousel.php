...
ct_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Team Carousel', 'intime'),
                    ...
                    'controls' => array(
                        array(
                            ...
                            'controls' => array(
                                ...
                                array(
                                    'name' => 'social',
                                    'label' => esc_html__( 'Social', 'intime' ),
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .ct-team-carousel5 .item--image::before' => 'background-color: {{VALUE}};',
                            ],
                            'condition' => [
                                'layout' => ['5'],
                            ],
