...
?>
<div class="ct-fancy-box ct-fancy-box-layout9 <?php echo esc_attr($settings['ct_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['ct_animate_delay']); ?>ms">
    ...
    <div class="item--holder">
        <?php if (!empty($settings['sub_title'])) : ?>
            <h6><?php echo esc_attr($settings['sub_title']); ?></h6>
        <?php endif; ?>
        <h3 class="item--title">
