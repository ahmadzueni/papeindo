...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-blog-carousel-layout3 ct-slick-slider">
        ...
        <?php
            ...
            <div class="carousel-item slick-slide">
                <div class="grid-item-inner <?php echo esc_attr($settings['ct_animate']); ?>">
                    ...
                    <?php endif; ?>
                    <div class="item--title"><a href="<?php echo esc_url(get_permalink( $post->ID )); ?>"><?php echo esc_attr(get_the_title($post->ID)); ?></a></div>
