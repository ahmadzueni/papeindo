...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-blog-carousel-layout5 ct-slick-slider">
                        ...
                        <?php if($show_author == 'true'): ?>
                            <div class="item-author">
                                <a href="<?php echo esc_url(get_author_posts_url($post->post_author, $author->user_nicename)); ?>">
                                    ...
                                    <label><?php echo esc_html__('Posted by', 'intime'); ?></label> <span><?php echo ' '.esc_html($author->display_name); ?></span>    
                                </a>
                            </div>
                        <?php endif; ?>
