...
<div class="ct-testimonial-wrap1 <?php echo esc_attr($settings['ct_animate']); ?>">
    <?php if(!empty($settings['wg_title']) || !empty($settings['wg_sub_title'])) : ?>
        <div class="ct-testimonial-top">
            <div class="ct-heading item-st-default">
                <div class="item--sub-title style-divider-right">
                    <span><?php echo esc_attr($settings['wg_sub_title']); ?></span>
                </div>
                <h3 class="item--title st-default">
                    <span><?php echo esc_attr($settings['wg_title']); ?></span>
                </h3>
            </div>
        </div>
    <?php endif; ?>
