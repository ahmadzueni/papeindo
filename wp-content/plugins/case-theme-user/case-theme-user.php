...
if (! class_exists('CaseUser')) {

    final class CaseUser
    {
        /**
        ...
        function add_scrips()
        {
            ...
            wp_localize_script( 'ct-user-form', 'userpress', array( 'ajax' => admin_url('admin-ajax.php'), 'nonce' => wp_create_nonce(CaseUser::NONCE) ) );
        ...
        {
            register_widget('CaseUser_Widget');
        }
    ...
    if (! function_exists('userpress')) {
        ...
        function userpress()
        {
            return CaseUser::instance();
        }
    }
    
    if (defined('CASEUSER_LATE_LOAD')) {
        
        add_action('plugins_loaded', 'userpress', (int) CASEUSER_LATE_LOAD);
    } else {
        userpress();
    }
}