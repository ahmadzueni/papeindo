...
if (! class_exists ( 'CaseUser_admin' )) {

	class CaseUser_admin {  
		...
		function plugin_action_links( $links ){
			...
			$action_links = array(
                 'settings' => '<a href="' . admin_url( 'users.php?page=ct-user-form_admin' ) . '" title="' . esc_attr( esc_html__( 'View Case User Settings', 'ct-user-form' ) ) . '">' . esc_html__( 'Settings', 'ct-user-form' ) . '</a>',
			);
		...
		function add_admin_page() {
			add_users_page ( esc_html__ ( 'Case User', 'ct-user-form' ), esc_html__ ( 'Case User', 'ct-user-form' ), 'manage_options', 'ct-user-form_admin', array (
				$this,
				'add_admin_page_main'
			) );
		}
		...
		function add_admin_page_main() {
			...
			?>
			<h1><?php esc_html_e('Case User', 'ct-user-form'); ?></h1>
                                    ...
                                    <th scope="row" class="titledesc">
                                            ...
                                            <td class="forminp">
                                                    <ul>
                                                            ...
                                                            <li data-value="<?php echo esc_attr($value); ?>" class="<?php if($option_value == $value){ echo "selected"; } ?>"></li>
