...
/**
 * Add Case User Widget.
 *
 * @name CaseUser_shortcodes
 * @since 1.0.0
 */
if (! class_exists ( 'CaseUser_Widget' )) {
	class CaseUser_Widget extends WP_Widget {
		function __construct() {
			parent::__construct ( 'userpress_widget', __ ( 'Case User', 'ct-user-form' ), array (
